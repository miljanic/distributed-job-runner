...
from djb_api.domain.auth.dto import TokenData, User
from djb_api.domain.auth.exceptions import InvalidJWT
...
async def get_current_user_or_none(
    request: Request, user_repository: UserRepository = Depends(UserRepository)
) -> Optional[User]:
    try:
